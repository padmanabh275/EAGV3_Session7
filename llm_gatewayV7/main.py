...
DEFAULT_ORDER = ["ollama", "openai", "gemini", "nvidia", "groq", "cerebras", "openrouter", "github"]
...
TIER_TO_ORDER = {
    "TINY":  ["github", "openrouter", "groq", "openai", "nvidia", "cerebras", "gemini", "ollama"],
    "LARGE": ["openai", "gemini", "groq", "nvidia", "cerebras", "github", "openrouter", "ollama"],
}
